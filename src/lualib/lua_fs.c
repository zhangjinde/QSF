...
static const char *perm2string(unsigned short mode) {
    //removed explicit \0 (it would be the second, 
    //since "" adds one already and perms[10] is only 10 big.
...
static void set_info(lua_State *L)
{
    ...
    lua_pushliteral(L, "LuaFileSystem is a Lua library developed to complement the set of functions"
