...
local table, string, coroutine, pairs, ipairs, tonumber, tostring, type, assert, require
    = table, string, coroutine, pairs, ipairs, tonumber, tostring, type, assert, require
