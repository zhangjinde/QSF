...
--See https://github.com/luapower/mysql
...
local assert, ipairs, pairs, type, setmetatable, tonumber, math, string
	= assert, ipairs, pairs, type, setmetatable, tonumber, math, string
